<template> 
    <div class="main">
        <h1>影院热映</h1>
        <section class="grid">
            <a href="" class="item" v-for="item in getTheaters">
                <div class="cover">
                    <div class="ratio3_4"><img :src="item.images.large" :alt="item.title" class="img-show" style="width: 100%;"></div>
                </div>
                <div class="info">
                    <h3>{{item.title}}</h3>
                    <p class="rank">
